...
export function buildNetworkConfig(env: PublicEnvironment) {
  ...
  return {
    ...
    logoPath: isMainnet ? '/lithoscan-logo.png' : '/lithoscan-icon.png',
    logoDarkPath: isMainnet ? '/lithoscan-logo-dark.png' : '/lithoscan-icon.png',
    faviconPath: isMainnet ? '/lithoscan-favicon.png' : '/makalu-testnet-favicon.png',
    faviconType: 'image/png' as const,
